...
data$cowcode <- ifelse(data$country == 'Bosnia and Herzegovina' | data$country == 'Bosnia-Herz' | data$country == 'Bosnia' | data$country == 'Bosnia and Herzego',346, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Congo, Rep.' | data$country == 'Congo' | data$country == 'Congo-Brazzaville' | data$country == 'Congo, Republic of' | data$country == 'Rep. of the Congo' | data$country == 'Rep. Of Congo' | data$country == 'Congo Brazzaville',484, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Czech Republic' | data$country == 'Czech Rep.' | data$country == 'Czechrep',316, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Cote d\'Ivoire' | data$country == 'Ivory Coast' | data$country == 'Côte d\'Ivoire' | data$country == 'Cote d´Ivoire' | data$country == 'Cote dIvoire' | data$country == 'Cote d\`Ivoire' | data$country == 'Cote D’Ivoire' | data$country == 'Cote D\`Ivoire',437, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Kuwait',690, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'St. Vincent and the Grenadines' | data$country == 'St. Vincent & Grenadines' | data$country == 'St.Vincent & Grenadines',57, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Yugoslavia' | data$country == 'Yugoslavia, FR (Serbia/Montenegro)' | data$country == 'Serbia and Montenegro' | data$country == 'Yugoslavia, FR(S/M)',345, data$cowcode)
data$cowcode <- ifelse(data$country == 'Zaire' | data$country == 'Congo, Dem. Rep.' | data$country == 'Democratic Republic of the Congo' | data$country == 'Dem. Rep. Congo' | data$country == 'Congo-Kinshasa' | data$country == 'Congo (DRC)' | data$country == 'Congo, Democratic Republic of' | data$country == 'Dem. Rep. of the Congo'| data$country == 'Dem. Rep. of Congo (Zaire)' | data$country == 'Congo, Dem. Republic' | data$country == 'Congo Kinshasa' | data$country == 'Democratic Republic of Congo (Zaire) ',490, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Macao' | data$country == 'Macao SAR, China' | data$country == 'China, P.R.: Macao' | data$country == 'China, Macao Special Administrative Region',716, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'West Bank and Gaza' | data$country == 'Palestine',1020, data$cowcode)
