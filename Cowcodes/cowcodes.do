#delimit;
		...
		replace cowcode =	346	if country == "Bosnia and Herzegovina" | country == "Bosnia-Herz" | country == "Bosnia" | country == "Bosnia and Herzego";		
		...
		replace cowcode = 484 if country == "Congo, Rep." | country == "Congo" | country == "Congo-Brazzaville" | country == "Congo, Republic of" | country == "Rep. of the Congo"
							   | country == "Rep. Of Congo" | country == "Congo Brazzaville";
		...
		replace cowcode =	316	if country == "Czech Republic" | country == "Czech Rep." | country == "Czechrep";
		...
		replace cowcode =	987	if country == "Federated States of Micronesia" | country == "Micronesia, Fed. Sts." ;
		...
		replace cowcode = 437 if country == "Cote d'Ivoire" | country == "Ivory Coast" | country == "Côte d'Ivoire" | country == "Cote d´Ivoire" | country == "Cote dIvoire"
							   | country == "Cote d\`Ivoire" | country == "Cote D’Ivoire" | country == "Cote D\`Ivoire";
		...
		replace cowcode =	343	if country == "Macedonia" | country == "Macedonia, FYR" | country == "Macedonia FYR" | country == "Macedonia,FYR";
		...
		replace cowcode =	359	if country == "Moldova" | country == "Moldovia" | country == "Republic of Moldova";		
		...
		replace cowcode = 732 if country == "Korea, Rep." | country == "South Korea" | country == "Korea, South" | country == "ROK" | country == "Korea, Republic of" 
							   | country == "Republic of Korea" | country == "S. Korea" | country == "Korea South" | country == "South Korea ";
		replace cowcode = 230 if country == "Spain" ;
		replace cowcode = 780 if country == "Sri Lanka" | country == "Sri Lanka (Ceylon)" ;
		replace cowcode =	60	if country == "St. Kitts and Nevis" | country == "St. Kitts & Nevis";		
		replace cowcode =	56	if country == "St. Lucia";		
		replace cowcode =	57	if country == "St. Vincent and the Grenadines" | country == "St. Vincent & Grenadines" | country == "St.Vincent & Grenadines";		
		...
		replace cowcode = 510 if country == "Tanzania" | country == "United Republic of Tanzania";
		replace cowcode = 800 if country == "Thailand" ;
		replace cowcode = 461 if country == "Togo" ;
		replace cowcode =	955	if country == "Tonga";		
		replace cowcode = 52 if country == "Trinidad and Tobago" | country == "Trinidad & Tobago" | country == "Trinidad-Tobago" ;
		...
		replace cowcode = 101 if country == "Venezuela" | country == "Venezuela, RB" | country == "Venezuela, Republica Bolivariana de" | country == "Venezuela, Rep";
		...
		replace cowcode =	680	if country == "Yemen People's Republic" | country == "Yemen, South" | country == "Yemen (PDR)" | country == "Yemen PDR" | country == "Yemen South" | country == "South Yemen" 
							     | country == "Aden/South Yemen";
		replace cowcode = 345 if country == "Yugoslavia" | country == "Yugoslavia, FR (Serbia/Montenegro)" | country == "Serbia and Montenegro" | country == "Yugoslavia, FR(S/M)";
		...
		replace cowcode = 715 if country == "Hong Kong" | country == "Hong Kong SAR, China" | country == "China, P.R.: Hong Kong" | country == "China, Hong Kong Special Administrative Region"
							   | country == "Hong Kong,China" | country == "Hong Kong SAR";
		replace cowcode = 716 if country == "Macao" | country == "Macao SAR, China" | country == "China, P.R.: Macao" | country == "China, Macao Special Administrative Region";
		...
		replace cowcode = 1020 if country == "West Bank and Gaza" | country == "Palestine";
