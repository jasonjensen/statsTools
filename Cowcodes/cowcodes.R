...
data$cowcode <- ifelse(data$country == 'North Korea' | data$country == 'Korea, Dem. Rep.' | data$country == 'Korea, North' | data$country == 'PRK' | data$country == 'Korea, Dem.Rep' | data$country == 'Korea North' | data$country == 'Korea (North)' | data$country == 'Korea (Democratic People\'s Rep. of)',731, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Zaire' | data$country == 'Congo, Dem. Rep.' | data$country == 'Democratic Republic of the Congo' | data$country == 'Dem. Rep. Congo' | data$country == 'Congo-Kinshasa' | data$country == 'Congo (DRC)' | data$country == 'Congo, Democratic Republic of' | data$country == 'Dem. Rep. of the Congo'| data$country == 'Dem. Rep. of Congo (Zaire)' | data$country == 'Congo, Dem. Republic' | data$country == 'Congo Kinshasa' | data$country == 'Democratic Republic of Congo (Zaire) ' | data$country == 'Congo, Democratic Republic' | data$country == 'Congo. Democratic Republic' | data$country == 'Democratic Republic of Congo' | data$country == 'Democratic Republic of the Congo ' | data$country == 'Congo (Democratic Republic of the)',490, data$cowcode)
