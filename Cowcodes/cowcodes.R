...
data$cowcode <- ifelse(data$country == 'Cote d\'Ivoire' | data$country == 'Ivory Coast' | data$country == 'Côte d\'Ivoire' | data$country == 'Cote d´Ivoire' | data$country == 'Cote dIvoire' | data$country == 'Cote d\`Ivoire' | data$country == 'Cote D’Ivoire' | data$country == 'Cote D\`Ivoire' | data$country =='Côte-d\'Ivoire' | data$country == 'Cote d´Ivoire' | data$country == 'Cote d?Ivoire' | data$country == 'Côte-d\'Ivoire' | data$country == 'Cote d´Ivoire' | data$country == 'Côte d´Ivoire' | data$country == 'Cote D\'Ivoire' | data$country == 'CÃ´te dâ€™Ivoire' | data$country == 'Cote d Ivoire',437, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Lao PDR' | data$country == 'Laos' | data$country == 'Lao People\'s Democratic Republic' | data$country == 'Lao Peopleâ€™s Dem. Rep.' | data$country == 'Lao People\'s Dem, Republic' | data$country == 'Lao People\'s Dem. Republic',812, data$cowcode)
