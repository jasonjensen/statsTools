...
data$cowcode <- ifelse(data$country == 'Bolivia' ,145, data$cowcode)
data$cowcode <- ifelse(data$country == 'Bosnia and Herzegovina' | data$country == 'Bosnia-Herz' | data$country == 'Bosnia' | data$country == 'Bosnia and Herzego' | data$country == 'Bosnia & Herzegovina' | data$country == 'Bosnia and Herzgegovina',346, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Cape Verde' | data$country == 'Cape Verde Island' | data$country == 'C. Verde Is.' ,402, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Federated States of Micronesia' | data$country == 'Micronesia, Fed. Sts.' ,987, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Cote d\'Ivoire' | data$country == 'Ivory Coast' | data$country == 'Côte d\'Ivoire' | data$country == 'Cote d´Ivoire' | data$country == 'Cote dIvoire' | data$country == 'Cote d\`Ivoire' | data$country == 'Cote D’Ivoire' | data$country == 'Cote D\`Ivoire' | data$country =='Côte-d\'Ivoire' | data$country == 'Cote d´Ivoire' | data$country == 'Cote d?Ivoire' | data$country == 'Côte-d\'Ivoire' | data$country == 'Cote d´Ivoire' | data$country == 'Côte d´Ivoire',437, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Macedonia' | data$country == 'Macedonia, FYR' | data$country == 'Macedonia FYR' | data$country == 'Macedonia,FYR' | data$country == 'FYR Macedonia' | data$country == 'Macedonia (Former Yugoslav Republic of)',343, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Moldova' | data$country == 'Moldovia' | data$country == 'Republic of Moldova' | data$country == 'Moldovaa',359, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'North Korea' | data$country == 'Korea, Dem. Rep.' | data$country == 'Korea, North' | data$country == 'PRK' | data$country == 'Korea, Dem.Rep' | data$country == 'Korea North' | data$country == 'Korea (North)',731, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Korea, Rep.' | data$country == 'South Korea' | data$country == 'Korea, South' | data$country == 'ROK' | data$country == 'Korea, Republic of' | data$country == 'Republic of Korea' | data$country == 'S. Korea' | data$country == 'Korea South' | data$country == 'South Korea ' | data$country == 'Korea (South)',732, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'St. Kitts and Nevis' | data$country == 'St. Kitts & Nevis',60, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Tanzania' | data$country == 'United Republic of Tanzania',510, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Trinidad and Tobago' | data$country == 'Trinidad & Tobago' | data$country == 'Trinidad-Tobago' ,52, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'United States' | data$country == 'USA'  | data$country == 'United States of America' | data$country == 'Usa',2, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Venezuela' | data$country == 'Venezuela, RB' | data$country == 'Venezuela, Republica Bolivariana de' | data$country == 'Venezuela, Rep',101, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Yemen People\'s Republic' | data$country == 'Yemen, South' | data$country == 'Yemen (PDR)' | data$country == 'Yemen PDR' | data$country == 'Yemen South' | data$country == 'South Yemen' | data$country == 'Aden/South Yemen',680, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Zaire' | data$country == 'Congo, Dem. Rep.' | data$country == 'Democratic Republic of the Congo' | data$country == 'Dem. Rep. Congo' | data$country == 'Congo-Kinshasa' | data$country == 'Congo (DRC)' | data$country == 'Congo, Democratic Republic of' | data$country == 'Dem. Rep. of the Congo'| data$country == 'Dem. Rep. of Congo (Zaire)' | data$country == 'Congo, Dem. Republic' | data$country == 'Congo Kinshasa' | data$country == 'Democratic Republic of Congo (Zaire) ' | data$country == 'Congo, Democratic Republic' | data$country == 'Congo. Democratic Republic' | data$country == 'Democratic Republic of Congo' | data$country == 'Democratic Republic of the Congo ',490, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Hong Kong' | data$country == 'Hong Kong SAR, China' | data$country == 'China, P.R.: Hong Kong' | data$country == 'China, Hong Kong Special Administrative Region'| data$country == 'Hong Kong,China' | data$country == 'Hong Kong SAR',715, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'West Bank and Gaza' | data$country == 'Palestine' | data$country == 'Palestinian Authority',1020, data$cowcode)
