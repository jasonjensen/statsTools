...
data$cowcode <- ifelse(data$country == 'Bosnia and Herzegovina' | data$country == 'Bosnia-Herz' | data$country == 'Bosnia' | data$country == 'Bosnia and Herzego' | data$country == 'Bosnia & Herzegovina' | data$country == 'Bosnia and Herzgegovina' | data$country == 'Bosnia-Herzgegovina',346, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Macedonia' | data$country == 'Macedonia, FYR' | data$country == 'Macedonia FYR' | data$country == 'Macedonia,FYR' | data$country == 'FYR Macedonia' | data$country == 'Macedonia (Former Yugoslav Republic of)' | data$country == 'Macedonia (FYR)',343, data$cowcode)
