...
data$cowcode <- ifelse(data$country == 'Congo, Rep.' | data$country == 'Congo' | data$country == 'Congo-Brazzaville' | data$country == 'Congo, Republic of' | data$country == 'Rep. of the Congo' | data$country == 'Rep. Of Congo' | data$country == 'Congo Brazzaville' | data$country == 'Congo, Republic of the' | data$country == 'Congo, Republic' | data$country == 'Congo. Republic' | data$country == 'Congo  Republic' | data$country == 'Congo Republic' | data$country == 'Congo (Brazzaville)' | data$country == 'Congo, Rep. Of' | data$country == 'Congo, Rep. of' | data$country == 'Republic of The Congo (Brazzaville)' | data$country == 'Congo, Rep',484, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Sao Tome and Principe' | data$country == 'SaoTome & Principe' | data$country == 'Sao Tome & Principe' | data$country == 'SÃ£o TomÃ© and Principe' | data$country == 'São Tomé & Príncipe',403, data$cowcode)
