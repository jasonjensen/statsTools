...
data$cowcode <- ifelse(data$country == 'Cote d\'Ivoire' | data$country == 'Ivory Coast' | data$country == 'Côte d\'Ivoire' | data$country == 'Cote d´Ivoire' | data$country == 'Cote dIvoire' | data$country == 'Cote d\`Ivoire' | data$country == 'Cote D’Ivoire' | data$country == 'Cote D\`Ivoire' | data$country =='Côte-d\'Ivoire' | data$country == 'Cote d´Ivoire' | data$country == 'Cote d?Ivoire' | data$country == 'Côte-d\'Ivoire' | data$country == 'Cote d´Ivoire' | data$country == 'Côte d´Ivoire' | data$country == 'CÃ´te d\'Ivoire',437, data$cowcode)
