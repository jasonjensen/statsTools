...
data$cowcode <- ifelse(data$country == 'Bosnia and Herzegovina' | data$country == 'Bosnia-Herz' | data$country == 'Bosnia' | data$country == 'Bosnia and Herzego' | data$country == 'Bosnia & Herzegovina',346, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Congo, Rep.' | data$country == 'Congo' | data$country == 'Congo-Brazzaville' | data$country == 'Congo, Republic of' | data$country == 'Rep. of the Congo' | data$country == 'Rep. Of Congo' | data$country == 'Congo Brazzaville' | data$country == 'Congo, Republic of the' | data$country == 'Congo, Republic',484, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Denmark' ,390, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Cote d\'Ivoire' | data$country == 'Ivory Coast' | data$country == 'Côte d\'Ivoire' | data$country == 'Cote d´Ivoire' | data$country == 'Cote dIvoire' | data$country == 'Cote d\`Ivoire' | data$country == 'Cote D’Ivoire' | data$country == 'Cote D\`Ivoire' | data$country =='Côte-d\'Ivoire' | data$country == 'Cote d´Ivoire' | data$country == 'Cote d?Ivoire',437, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Macedonia' | data$country == 'Macedonia, FYR' | data$country == 'Macedonia FYR' | data$country == 'Macedonia,FYR',343, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Moldova' | data$country == 'Moldovia' | data$country == 'Republic of Moldova',359, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'North Korea' | data$country == 'Korea, Dem. Rep.' | data$country == 'Korea, North' | data$country == 'PRK' | data$country == 'Korea, Dem.Rep' | data$country == 'Korea North',731, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Korea, Rep.' | data$country == 'South Korea' | data$country == 'Korea, South' | data$country == 'ROK' | data$country == 'Korea, Republic of' | data$country == 'Republic of Korea' | data$country == 'S. Korea' | data$country == 'Korea South' | data$country == 'South Korea ',732, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'St. Lucia',56, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Tajikistan',702, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Zaire' | data$country == 'Congo, Dem. Rep.' | data$country == 'Democratic Republic of the Congo' | data$country == 'Dem. Rep. Congo' | data$country == 'Congo-Kinshasa' | data$country == 'Congo (DRC)' | data$country == 'Congo, Democratic Republic of' | data$country == 'Dem. Rep. of the Congo'| data$country == 'Dem. Rep. of Congo (Zaire)' | data$country == 'Congo, Dem. Republic' | data$country == 'Congo Kinshasa' | data$country == 'Democratic Republic of Congo (Zaire) ' | data$country == 'Congo, Democratic Republic',490, data$cowcode)
