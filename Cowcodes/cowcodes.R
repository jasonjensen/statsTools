...
data$cowcode <- ifelse(data$country == 'Russian Federation' | data$country == 'USSR' | data$country == 'Russia' | data$country == 'Soviet Union' | data$country == 'Russian Federat' | data$country == 'Ussr' | data$country == 'Russia (Soviet Union)',365, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'United Kingdom' | data$country == 'UK' | data$country == 'Uk',200, data$cowcode)
