...
data$cowcode <- ifelse(data$country == 'Central African Republic' | data$country == 'Central Afr. Rep.' | data$country == 'Cen. African Rep.' | data$country == 'Cent. Af. Rep.' | data$country == 'Central African Rep.' | data$country == 'Central African Re' | data$country == 'Central African Repub',482, data$cowcode)
data$cowcode <- ifelse(data$country == 'Chad' ,483, data$cowcode)
data$cowcode <- ifelse(data$country == 'Chile' ,155, data$cowcode)
data$cowcode <- ifelse(data$country == 'China' | data$country == 'PRC' | data$country == 'China, P.R.: Mainland' | data$country == 'China, P.R.',710, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Congo, Rep.' | data$country == 'Congo' | data$country == 'Congo-Brazzaville' | data$country == 'Congo, Republic of' | data$country == 'Rep. of the Congo' | data$country == 'Rep. Of Congo' | data$country == 'Congo Brazzaville' | data$country == 'Congo, Republic of the' | data$country == 'Congo, Republic' | data$country == 'Congo. Republic' | data$country == 'Congo  Republic' | data$country == 'Congo Republic' | data$country == 'Congo (Brazzaville)' | data$country == 'Congo, Rep. Of' | data$country == 'Congo, Rep. of' | data$country == 'Republic of The Congo (Brazzaville)',484, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Federated States of Micronesia' | data$country == 'Micronesia, Fed. Sts.' | data$country == 'Micronesia (Federated States of)' | data$country == 'Micronesia, Federated States of',987, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Cote d\'Ivoire' | data$country == 'Ivory Coast' | data$country == 'Côte d\'Ivoire' | data$country == 'Cote d´Ivoire' | data$country == 'Cote dIvoire' | data$country == 'Cote d\`Ivoire' | data$country == 'Cote D’Ivoire' | data$country == 'Cote D\`Ivoire' | data$country =='Côte-d\'Ivoire' | data$country == 'Cote d´Ivoire' | data$country == 'Cote d?Ivoire' | data$country == 'Côte-d\'Ivoire' | data$country == 'Cote d´Ivoire' | data$country == 'Côte d´Ivoire' | data$country == 'Cote D\'Ivoire' | data$country == 'CÃ´te dâ€™Ivoire',437, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Lao PDR' | data$country == 'Laos' | data$country == 'Lao People\'s Democratic Republic' | data$country == 'Lao Peopleâ€™s Dem. Rep.' | data$country == 'Lao People\'s Dem, Republic',812, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Sao Tome and Principe' | data$country == 'SaoTome & Principe' | data$country == 'Sao Tome & Principe' | data$country == 'SÃ£o TomÃ© and Principe',403, data$cowcode)
...
data$cowcode <- ifelse(data$country == 'Virgin Islands, British',1031, data$cowcode)
